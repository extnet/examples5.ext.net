...
<head runat="server">
    ...
    <script type="text/javascript">
        // The overrides below allow a 'ghost=false' support similar to Ext.window.Window.
        Ext.panel.DD.override({
            b4StartDrag: function (x, y) {
                if (this.panel.ghost != false) this.panelProxy.show();
            },
            getDragEl: function (e) {
                if (this.panel.ghost != false) {
                    var ghost = this.panelProxy.ghost;
                    if (ghost) {
                        return ghost.el.dom;
                    }
                } else {
                    return this.panel.el.dom;
                }
            }
        });
        Ext.dd.DragSource.override({
            alignElWithMouse: function () {
                if (this.ghost != false) this.proxy.ensureAttachedToBody(true);
...
<body>
    ...
    <p>
        The following example shows the classic SVG Tiger.  Because the new Ext.Draw system extends from Component,
            we get all the functionality available to any component.
    ...
    <ext:DrawContainer
        ...
        BodyStyle="background-color: transparent; border: transparent"
        ...
        <%-- We created with the override above a setup option similar to window's Ghost = false. Don't set it 'true' likewise.
            http://docs.sencha.com/extjs/6.5.0/classic/Ext.window.Window.html#cfg-ghost --%>
        <CustomConfig>
            <ext:ConfigItem Name="ghost" Value="false" />
        </CustomConfig>
        <Items>
            <ext:PathSprite TranslationX="185" TranslationY="145"
