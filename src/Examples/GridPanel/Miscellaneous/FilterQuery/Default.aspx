...
<script runat="server">
    ...
    protected void ApplyFilter(object sender, DirectEventArgs e)
    {
        ...
        Store1.AddFilter(new FilterQuery(query));
...
<html>
<head runat="server">
    <title>The FilterQuery filter - Ext.NET Examples</title>
            ...
            <ext:Toolbar runat="server">
                <Items>
                    ...
                    <ext:Button
                        ...
                        Handler="var fquery='company like &quot;Ameri&quot; or price > 75'; App.Store1.addFilter(new Ext.data.Query(fquery)); Ext.toast('Client-filtered by query: ' + fquery);" />
                </Items>
            </ext:Toolbar>
        </BottomBar>
    </ext:GridPanel>
