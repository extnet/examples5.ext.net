...
<ext:FormPanel
    ...
    <Items>
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/7.2.0/classic/Ext.grid.plugin.BufferedRenderer.html#cfg-leadingBufferZone' target='docs' tabIndex='-1'>leadingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/7.2.0/classic/Ext.data.BufferedStore.html#cfg-purgePageCount' target='docs' tabIndex='-1'>BufferedStore purgePageCount</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/7.2.0/classic/Ext.grid.plugin.BufferedRenderer.html#cfg-scrollToLoadBuffer' target='docs' tabIndex='-1'>BufferedRenderer scrollToLoadBuffer</a>"
