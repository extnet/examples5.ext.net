...
<ext:FormPanel
    ...
    <Items>
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.panel.Table-cfg-trailingBufferZone' target='docs' tabIndex='-1'>trailingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.grid.plugin.BufferedRenderer-cfg-leadingBufferZone' target='docs' tabIndex='-1'>leadingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.panel.Table-cfg-numFromEdge' target='docs' tabIndex='-1'>numFromEdge</a>"
        ...
        <ext:Checkbox runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.data.BufferedStore' target='docs' tabIndex='-1'>BufferedStore</a>"
            ItemID="buffered">
            <Listeners>
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.data.BufferedStore-cfg-pageSize' target='docs' tabIndex='-1'>BufferedStore pageSize</a>"
            ItemID="pageSize"
            Number="150"
            Disabled="true" />
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.data.BufferedStore-cfg-trailingBufferZone' target='docs' tabIndex='-1'>BufferedStore trailingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.data.BufferedStore-cfg-leadingBufferZone' target='docs' tabIndex='-1'>BufferedStore leadingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.data.BufferedStore-cfg-purgePageCount' target='docs' tabIndex='-1'>BufferedStore purgePageCount</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs-origin.sencha.com/extjs/5.0/apidocs/#!/api/Ext.grid.plugin.BufferedRenderer-cfg-scrollToLoadBuffer' target='docs' tabIndex='-1'>BufferedRenderer scrollToLoadBuffer</a>"
