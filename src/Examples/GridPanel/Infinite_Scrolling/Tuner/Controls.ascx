...
<ext:FormPanel
    ...
    <Items>
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.panel.Table.html#cfg-trailingBufferZone' target='docs' tabIndex='-1'>trailingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.grid.plugin.BufferedRenderer.html#cfg-leadingBufferZone' target='docs' tabIndex='-1'>leadingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.panel.Table.html#cfg-numFromEdge' target='docs' tabIndex='-1'>numFromEdge</a>"
        ...
        <ext:Checkbox runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.data.BufferedStore' target='docs' tabIndex='-1'>BufferedStore</a>"
            ItemID="buffered">
            <Listeners>
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.data.BufferedStore.html#cfg-pageSize' target='docs' tabIndex='-1'>BufferedStore pageSize</a>"
            ItemID="pageSize"
            Number="150"
            Disabled="true" />
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.data.BufferedStore.html#cfg-trailingBufferZone' target='docs' tabIndex='-1'>BufferedStore trailingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.data.BufferedStore.html#cfg-leadingBufferZone' target='docs' tabIndex='-1'>BufferedStore leadingBufferZone</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.data.BufferedStore.html#cfg-purgePageCount' target='docs' tabIndex='-1'>BufferedStore purgePageCount</a>"
        ...
        <ext:NumberField
            runat="server"
            FieldLabel="<a href='http://docs.sencha.com/extjs/6.7.0/classic/Ext.grid.plugin.BufferedRenderer.html#cfg-scrollToLoadBuffer' target='docs' tabIndex='-1'>BufferedRenderer scrollToLoadBuffer</a>"
